...
var source = (() => {
  ...
  var require_fr = __commonJS({
    "node_modules/moment/locale/fr.js"(exports, module) {
      (function(global, factory) {
        ...
        var fr = moment2.defineLocale("fr", {
  ...
  // src/WebtoonFR/WebtoonFR.ts
  var WebtoonFR_exports = {};
  __export(WebtoonFR_exports, {
    WebtoonFR: () => WebtoonFR,
    WebtoonFRInfo: () => WebtoonFRInfo
  });
  ...
  var VERSION = "0.0.0";
  var LANGUAGE_INFO = "French";
  var SOURCE_NAME = "WebtoonFR";
  var HAVE_TRENDING = true;
  var SOURCE_TAGS = [{ text: "French", type: import_types2.BadgeColor.GREY }];
  var WebtoonFRInfo = {
    ...WebtoonBaseInfo,
    name: SOURCE_NAME,
