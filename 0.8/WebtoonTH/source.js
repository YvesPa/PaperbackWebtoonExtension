...
var source = (() => {
  ...
  var require_th = __commonJS({
    "node_modules/moment/locale/th.js"(exports, module) {
      (function(global, factory) {
        ...
        "use strict";
        var th = moment2.defineLocale("th", {
  ...
  // src/WebtoonTH/WebtoonTH.ts
  var WebtoonTH_exports = {};
  __export(WebtoonTH_exports, {
    WebtoonTH: () => WebtoonTH,
    WebtoonTHInfo: () => WebtoonTHInfo
  });
  ...
  var VERSION = "0.0.0";
  var LANGUAGE_INFO = "Thai";
  var SOURCE_NAME = "WebtoonTH";
  var HAVE_TRENDING = true;
  var SOURCE_TAGS = [{ text: "Thai", type: import_types2.BadgeColor.GREY }];
  var WebtoonTHInfo = {
    ...WebtoonBaseInfo,
    name: SOURCE_NAME,
