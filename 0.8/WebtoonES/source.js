...
var source = (() => {
  ...
  // src/WebtoonES/WebtoonES.ts
  var WebtoonES_exports = {};
  __export(WebtoonES_exports, {
    WebtoonES: () => WebtoonES,
    WebtoonESInfo: () => WebtoonESInfo
  });
  ...
  var VERSION = "0.0.0";
  var LANGUAGE_INFO = "Spanish";
  var SOURCE_NAME = "WebtoonES";
  var HAVE_TRENDING = false;
  var SOURCE_TAGS = [{ text: "Spanish", type: import_types2.BadgeColor.GREY }];
  var WebtoonESInfo = {
    ...WebtoonBaseInfo,
    name: SOURCE_NAME,
