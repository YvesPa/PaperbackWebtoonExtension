...
const VERSION = '0.0.0';
const LANGUAGE_INFO = 'Spanish';
const SOURCE_NAME = 'WebtoonES';
const HAVE_TRENDING = false;
const SOURCE_TAGS = [{ text: 'Spanish', type: types_1.BadgeColor.GREY }];
exports.WebtoonESInfo = {
...
class WebtoonES extends Webtoon_1.Webtoon {
    constructor(cheerio) {
        super(cheerio, LOCALE, DATE_FORMAT, LANGUAGE, BASE_URL, MOBILE_URL, HAVE_TRENDING);
    }
}
exports.WebtoonES = WebtoonES;

},{"../Webtoon":64,"@paperback/types":61,"moment/locale/es":62}],66:[function(require,module,exports){
"use strict";
