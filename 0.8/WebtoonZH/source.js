...
var source = (() => {
  ...
  // src/WebtoonZH/WebtoonZH.ts
  var WebtoonZH_exports = {};
  __export(WebtoonZH_exports, {
    WebtoonZH: () => WebtoonZH,
    WebtoonZHInfo: () => WebtoonZHInfo
  });
  ...
  var VERSION = "0.0.0";
  var LANGUAGE_INFO = "Chinese (Traditional)";
  var SOURCE_NAME = "WebtoonZH";
  var HAVE_TRENDING = true;
  var SOURCE_TAGS = [{ text: "Chinese (Traditional)", type: import_types2.BadgeColor.GREY }];
  var WebtoonZHInfo = {
    ...WebtoonBaseInfo,
    name: SOURCE_NAME,
