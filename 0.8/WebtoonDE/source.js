...
exports.WebtoonBaseInfo = {
    version: (0, exports.getExportVersion)('0.0.0'),
    name: 'Webtoon',
    description: `Extension that pulls manga from ${exports.BASE_URL_XX}`,
    author: 'YvesPa',
...
class Webtoon {
    ...
    getMangaShareUrl(mangaId) { return `${this.BASE_URL}/${mangaId}`; }
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.WebtoonDE = exports.WebtoonDEInfo = void 0;
const types_1 = require("@paperback/types");
...
const LANGUAGE = 'de';
const BASE_URL = `${Webtoon_1.BASE_URL_XX}/${LOCALE}`;
const MOBILE_URL = `${Webtoon_1.MOBILE_URL_XX}/${LOCALE}`;
const VERSION = '0.0.0';
const LANGUAGE_INFO = 'German';
const SOURCE_NAME = 'WebtoonDE';
const HAVE_TRENDING = false;
const SOURCE_TAGS = [{ text: 'German', type: types_1.BadgeColor.GREY }];
exports.WebtoonDEInfo = {
...
class WebtoonDE extends Webtoon_1.Webtoon {
    constructor(cheerio) {
        super(cheerio, LOCALE, DATE_FORMAT, LANGUAGE, BASE_URL, MOBILE_URL, HAVE_TRENDING);
    }
}
exports.WebtoonDE = WebtoonDE;

},{"../Webtoon":64,"@paperback/types":61,"moment/locale/de":62}],66:[function(require,module,exports){
"use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
Object.defineProperty(exports, "__esModule", { value: true });
exports.WebtoonParser = void 0;
const moment_1 = __importDefault(require("moment"));
class WebtoonParser {
    constructor(dateFormat, language, BASE_URL, MOBILE_URL) {
