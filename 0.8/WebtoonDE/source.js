...
var source = (() => {
  ...
  var require_de = __commonJS({
    "node_modules/moment/locale/de.js"(exports, module) {
      (function(global, factory) {
  ...
  // src/WebtoonDE/WebtoonDE.ts
  var WebtoonDE_exports = {};
  __export(WebtoonDE_exports, {
    WebtoonDE: () => WebtoonDE,
    WebtoonDEInfo: () => WebtoonDEInfo
  });
  ...
  var VERSION = "0.0.0";
  var LANGUAGE_INFO = "German";
  var SOURCE_NAME = "WebtoonDE";
  var HAVE_TRENDING = false;
  var SOURCE_TAGS = [{ text: "German", type: import_types2.BadgeColor.GREY }];
  var WebtoonDEInfo = {
    ...WebtoonBaseInfo,
    name: SOURCE_NAME,
